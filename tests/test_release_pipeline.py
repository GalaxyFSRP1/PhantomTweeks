...
# The exe/msi/portable smoke tests were removed from CI on request after they
# repeatedly hung the runner. The frozen relative-import regression they
# guarded against is still covered, but by unit tests that execute the entry
# points directly (test_frozen_entry.py) rather than by launching the built
# binary on a Windows runner.

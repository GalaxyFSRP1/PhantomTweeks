...
from ..core import premium, features, gamewatch, selftest
...
class PhantomWindow(tk.Tk):
    ...
    def _build_chrome(self) -> None:
        ...
        ttk.Button(nav, text="Export Report…", style="Chip.TButton",
                   command=self._export_report).pack(fill="x", padx=10, pady=(0, 6))
        ttk.Button(nav, text="RESTORE EVERYTHING", style="Danger.TButton",
                   command=self._restore_everything).pack(fill="x", padx=10, pady=6)

        # Live game indicator, updated by the background GameWatcher.
    ...
    def _build_dashboard(self) -> None:
        ...
        self.score_chart = BarChart(left, height=300)
        self.score_chart.pack(fill="both", expand=True, pady=(4, 8))
        ttk.Button(left, text="Calculate Score", style="Accent.TButton",
                   command=self._calc_score).pack(anchor="w")

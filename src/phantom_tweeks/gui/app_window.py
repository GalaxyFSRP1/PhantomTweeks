...
PAGE_SECTION = {
    ...
    "registry": "tweaks", "perftweaks": "tweaks", "nvidia": "dashboard", "nettweaks": "tweaks", "dns": "dashboard", "games": "dashboard", "background": "dashboard",
...
class PhantomWindow(tk.Tk):
    ...
    def _build_nvidia(self) -> None:
        ...
        self.nv_panel = self._scroll_text(page)
